...
public class TestJWT {
    ...
    public void testDecodeToken(){
        String token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJtb2JpbGUiOiIxMzMzMzMzMzMzIiwiaWQiOiIyIiwiZXhwIjoxNjA4OTY2OTYwfQ.SjKsfdSKt0YrIc4cfUTZnumxzXQnBWr6MduTdSfXsbM";
        try {
            // 通过token解析数据
